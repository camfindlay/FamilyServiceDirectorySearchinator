    ...
    return (
      <div className="container-fluid">
        <div className="service-info">
          ...
          <dl>
            <dt>Organisation purpose</dt><dd>{props.ORGANISATION_PURPOSE}</dd>
            <dt>Physical address</dt><dd>{props.PHYSICAL_ADDRESS}</dd>
            <dt>Delivery Methods</dt><dd>{props.DELIVERY_METHODS}</dd>
            <dt>Costs</dt><dd>{props.COST_TYPE}</dd>
            <dt>Service referrals</dt><dd>{props.SERVICE_REFERRALS}</dd>
          </dl>
        </div>
      </div>
    );
